...
const options = [
  { value: "ยังไม่ได้ประเมิน", label: "่ยังไม่ได้ประเมิน" },
...
const data = [
    {
      ...
      status: <p className="text-[#0C7CF4]">ยังไม่ได้ประเมิน</p>,
      edit: <FiEdit className="cursor-pointer"  onClick={handleUpload} />,
      see: <Link><FaEye /></Link>
    },
    {
        id: 2,
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
                <div className="bg-white rounded-lg shadow-lg w-6/12 h-fit ">
                  ...
                  <div className="mt-4 flex justify-center py-2 px-4 gap-5">
                    <button className="bg-[#08C054] px-4 py-2 rounded-md text-white">บันทึก</button>
                    <button
